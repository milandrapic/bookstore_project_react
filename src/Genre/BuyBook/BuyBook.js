...
//sets the book value of the state after the initial render
    ...
    updateBookOnMount = () => {
        axios.get('https://thebookclub4413.herokuapp.com/getBookById?id=' + this.getHash()).then(
            (response) => {
    ...
    bookView = ()=>{
        axios.post('https://thebookclub4413.herokuapp.com/addView?id=' + this.state.book.bookId).then(
            (response) => {
                console.log(response.data);
            }
        );
    ...
    submitReview = () => {
        ...
        axios.post('https://thebookclub4413.herokuapp.com/addReview',body, {headers:headers}).then(
            (response) => {
