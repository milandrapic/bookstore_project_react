...
class Analytics extends Component {
    ...
    getUserTotalSpent = () => {
        ...
        axios.get('https://thebookclub4413.herokuapp.com/userTotalSpent', {headers: headers}).then(
            response => {
                this.setState({
    ...
    getUserTotalSpentOnBooks = () => {
        ...
        axios.get('https://thebookclub4413.herokuapp.com/userTotalSpentOnBooks', {headers: headers}).then(
            response => {
                this.setState({
    ...
    getMonthlyStats = () => {
        ...
        axios.get('https://thebookclub4413.herokuapp.com/monthlyStats', {headers: headers}).then(
            response => {
                this.setState({
    ...
    getTopViews = () => {
        ...
        axios.get('https://thebookclub4413.herokuapp.com/topViews', {headers: headers}).then(
            response => {
                this.setState({
    ...
    getTopSales = () => {
        ...
        axios.get('https://thebookclub4413.herokuapp.com/topSales',{headers: headers}).then(
            response => {
                this.setState({
        ...
        return (
            <div className="Analytics">
                <div style= {{marginLeft:"20%", marginRight:"20%",width:"60%", textAlign:"center"}}>
                 ...
                 <tr><th>Books Sold</th><th>Title</th></tr>
                 {topSales}
                 </table>
                 </div>
                 ...
                 <table style= {{border:"2px solid black", width:"100%"}}>
                 <tr><th>Book Views</th><th>Title</th></tr>
                 {topViews}
                 </table>
                 </div>
                <div style= {{marginLeft:"20%", marginRight:"20%",width:"60%", textAlign:"center"}}>
