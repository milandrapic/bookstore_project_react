        ...
        return (
            <div>
                ...
                <h2>Total Each User Has Spent on Each Book</h2>
                 <table>
                 <tr><td>Username</td><td>Title</td><td>Author</td><td>Price</td><td>Quantity</td><td>Postal Code</td><td>Total Spent</td></tr>
                    {userSpentOnBooks}
                 </table>
                 </div>
                 <div style= {{marginLeft:"20%", marginRight:"20%",width:"60%", textAlign:"center"}}>
                <h2>Total Each User Has Spent in Total</h2>
                 <table>
                 <tr><td>Username</td><td>Total Items Bought</td><td>Postal Code</td><td>Total Spent</td></tr>
                    {userSpent}
                 </table>
                 </div>
            </div>
